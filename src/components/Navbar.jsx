...
const Navbar = () => {
   ...
   return (
      <>
         <nav className="nav bg-white fixed z-10 top-0 left-0 right-0 md:block font-playfair">
            <div className="navContainer h-[55px] flex items-center justify-between max-w-full mx-20">
               <div>
                  <RiMenu4Line size={23} onClick={toggleMenu} />
               </div>
               <div className="h-[80px] w-[80px] flex items-center justify-center gpa-2">
                  {/* <img src={Logo} alt="" /> */}
                  <a  className="cursor-pointer" href="/">Logo here</a>
               </div>
               <div>
                  <ul className="flex items-center justify-between gap-5">
                     <li>
                        <BiSearch size={23} onClick={toggleSearch} />
                     </li>
                     <li>
                        <RiHeart2Line size={23}></RiHeart2Line>
                     </li>
                     <li>
                        <FiShoppingBag size={23}></FiShoppingBag>
                     </li>
                     <li>
                        <TbUser size={23}></TbUser>
                     </li>
                  </ul>
               </div>
            </div>
         ...
         <div
            ...
            } fixed top-0 left-0 h-full w-64 z-50 bg-white shadow-lg transition-transform ease-in-out duration-300`}
         >
